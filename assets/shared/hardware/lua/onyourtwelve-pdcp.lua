return {
  ...
  controls = {
    ...
    { id = "pdcp-hsd-ecm", key = "JOY_BTN21", type = "switch-position", hardwareLabel = "ECM OVERRIDE OFF" },
    { id = "pdcp-ecm-on", key = "JOY_BTN22", type = "switch-position", hardwareLabel = "ECM OVERRIDE ON" },
